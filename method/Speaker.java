...
public static void increasesval(){
	...
	if(isConnected==true){
		if(currentval<=maxval){
			...
			System.out.println("the increases value is:"+currentval);
		}else{
			System.out.println("the valuem will crosed");
		
	    }
	 System.out.println("plz can you on the Speaker");
	}
...
public static void decreasesval(){
	...
	if(isConnected==true){
	 ...
	 System.out.println("could you on the Speaker");
	}
